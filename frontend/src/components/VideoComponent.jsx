...
const VideoComponent = () => {
  ...
  return (
      <>
        ...
        <video width="100%" height="auto" autoPlay muted className={`relative z-10 shadow-shadow-custom transition-opacity duration-500 ease-in-out ${isVideoLoaded ? 'opacity-100' : 'opacity-0'}`}
